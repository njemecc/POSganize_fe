...
const Rules = () => {
  ...
  <ul style={}>
 {width:"80%",margin:"5rem auto", display:"flex",flexDirection:"column",gap:"2rem",alignItems:"center", padding:"40px",backgroundColor:"#f9f9f9",borderRadius:"8px",boxShadow:" 0 0 10px rgba(0, 0, 0, 0.1)"}   <li style={{width:"100%",display:"flex",alignItems:"center",gap:"1rem"}}><MdWatchLater style={{color:"orange",fontSize:"2rem"}}/> <Heading as="h1">  Always be on time!</Heading></li>
